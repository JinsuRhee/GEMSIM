...
<div>
  ...
  <header id="nav-container">
    <a href="index.html"><img src="images/gem_logo.png" /></a>
    <h1><a href="index.html"> GEM Simulations </a></h1>
    <nav>
      <ul>
        <li><a href="des.html">Descriptions</a></li>
        <li><a href="spec.html">Spec</a></li>
        <li><a href="data.html">Data Access</a></li>
        <li><a href="spine.html">Who does what?</a></li>
      ...
      <section>
        ...
        <p>
          You are welcome to play with the GEM simulation data <a
            href="data.html">here</a
          >. When you are planning to publish your work, please refer to the
          below publication policy.
        </p>
        <br />
        <ul>
  ...
  <footer id="footer">
    <hr />
    <p>
      (c) Yonsei University <span class="bold">G</span>alaxy
      <span class="bold">E</span>volution <span class="bold">M</span>eeting
    </p>
  </footer>
</div>
